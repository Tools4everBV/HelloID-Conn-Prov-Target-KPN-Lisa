###################################################################
# HelloID-Conn-Prov-Target-KPNLisa-AuthorizationProfiles-Revoke
# PowerShell V2
###################################################################
...
try {
    ...
    $SplatParams = @{
        Uri    = "$($actionContext.Configuration.BaseUrl)/AuthorizationProfiles/$($actionContext.References.Permission.Reference)/members/$($actionContext.References.Account)"
        Method = "Delete"
    }
