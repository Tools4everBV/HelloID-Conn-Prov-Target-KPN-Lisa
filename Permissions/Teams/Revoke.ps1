###################################################################
# HelloID-Conn-Prov-Target-KPNLisa-Teams-Revoke
# PowerShell V2
###################################################################
...
try {
    ...
    $SplatParams = @{
        Uri    = "$($actionContext.Configuration.BaseUrl)/Teams/$($actionContext.References.Permission.Reference)/members/$($actionContext.References.Account)"
        Method = "Delete"
    }
