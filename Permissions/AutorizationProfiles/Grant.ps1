###################################################################
# HelloID-Conn-Prov-Target-KPNLisa-AuthorizationProfiles-Grant
# PowerShell V2
###################################################################
...
try {
    ...
    $SplatParams = @{
        Uri    = "$($actionContext.Configuration.BaseUrl)/AuthorizationProfiles/$($actionContext.References.Permission.Reference)/members"
        Method = "Post"
